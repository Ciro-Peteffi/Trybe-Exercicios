...
function corTarefa(color){
  let elementDivTask = document.createElement('div');
  let getDivMyTasks = document.getElementsByClassName('my-tasks');
  getDivMyTasks[0].appendChild(elementDivTask);
  elementDivTask.classList.add('task');
  elementDivTask.style.background = color;
}
corTarefa(color);
